...
The GDScript tests under `test/` use GUT and require that dependency to be
installed separately. CI currently runs the Godot addon smoke test and the
Godot-independent Catch2 native tests; it does not claim that the GUT suite
